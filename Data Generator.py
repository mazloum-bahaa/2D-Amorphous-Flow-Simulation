...
if __name__ == "__main__":
    base_path = "Flow_N900_alpha2.500_phi1.200_delta0.150_gamma3.000_w0.500_sigm_obs10.000_K10.000_fx_ext0.001000_dt0.100"
    output_file = "output_timestep=20.txt"
    
    with open(output_file, 'w') as f:
        f.write("900 46.7192005534 15.5730668511\n")
    
    for n in range(500):
        file_num = 1000 + n*20
        file_t = os.path.join(base_path, f"data_{file_num:05d}")
        file_t1 = os.path.join(base_path, f"data_{file_num+20:05d}")
        
        print(f"Processing files {file_num} and {file_num+20}...")
